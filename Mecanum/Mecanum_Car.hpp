...
public:
    int Now_spd;
    Mecanum_Car(MotorType *_LF_Wheel, MotorType *_RF_Wheel, MotorType *_LR_Wheel, MotorType *_RR_Wheel)
    {
    ...
    {
        LF_Wheel_Spd = constrain((Line_vel + Pan_vel + Angle_vel * 0.25) * 21.25, -MAX_RPM, MAX_RPM);
        RF_Wheel_Spd = constrain((Line_vel - Pan_vel - Angle_vel * 0.25) * 21.25, -MAX_RPM, MAX_RPM);
        LR_Wheel_Spd = constrain((Line_vel - Pan_vel + Angle_vel * 0.25) * 21.25, -MAX_RPM, MAX_RPM);
        RR_Wheel_Spd = constrain((Line_vel + Pan_vel - Angle_vel * 0.25) * 21.25, -MAX_RPM, MAX_RPM);
    }
